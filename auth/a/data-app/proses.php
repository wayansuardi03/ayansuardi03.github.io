...
if (isset($_POST['btnTambahDataApp'])) {
    $aplikasi = mysqli_escape_string($koneksi, trim($_POST['aplikasi']));
    $jenis = mysqli_escape_string($koneksi, trim($_POST['jenis']));
    $kategori = mysqli_escape_string($koneksi, trim($_POST['kategori']));
    $tautan = mysqli_escape_string($koneksi, trim($_POST['tautan']));
    $author = mysqli_escape_string($koneksi, trim($_POST['authorId']));
    $catatan = mysqli_escape_string($koneksi, trim($_POST['keterangan']));
